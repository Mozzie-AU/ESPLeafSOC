...
//   CAN TX:  GPIO5  (required by TWAI driver but not driven - receive only)
//   CAN RX:  GPIO35 (TBC - verify from T-CAN485 schematic)
//   WS2812:  GPIO4
//   I2C SDA: GPIO25 (TBC - verify available on 12-pin header)
//   I2C SCL: GPIO26 (TBC - verify available on 12-pin header)
//
// Libraries required:
...
//   1. Confirm CAN RX GPIO from T-CAN485 schematic (currently GPIO35)
//   2. Confirm I2C SDA/SCL GPIOs from 12-pin header pinout
//   3. Verify U8G2 I2C constructor for SH1106 128x64
//   4. Install ESPAsyncWebServer and AsyncTCP libraries
//   5. Install FastLED library
// ============================================================
...
// ------------------------------------------------------------
// Hardware pin definitions  (TBC - verify from schematic)
// ------------------------------------------------------------
#define CAN_TX_PIN      5     // Required by TWAI driver - not actively driven (RX only)
#define CAN_RX_PIN      35    // TBC from T-CAN485 schematic
#define I2C_SDA_PIN     25    // TBC from T-CAN485 12-pin header
#define I2C_SCL_PIN     26    // TBC from T-CAN485 12-pin header
#define WS2812_PIN      4
